...
@section('content')
        ...
        <div class="px-8 py-5 grid grid-rows-[50px_1fr] md:bg-slate-50 ">
                <div class="flex justify-between items-center">
                        ...
                        <svg class="size-10 bg-blue-100 p-2 rounded-full text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" >
